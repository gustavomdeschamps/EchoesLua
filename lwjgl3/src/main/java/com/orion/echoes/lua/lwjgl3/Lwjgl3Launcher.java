package com.orion.echoes.lua.lwjgl3;
...
public class Lwjgl3Launcher {
    ...
    private static Lwjgl3Application createApplication() {
        return new Lwjgl3Application(new EchoesLua(), getDefaultConfiguration());
    }

    private static Lwjgl3ApplicationConfiguration getDefaultConfiguration() {
        Lwjgl3ApplicationConfiguration configuration = new Lwjgl3ApplicationConfiguration();
        configuration.setTitle("Echoes of Lua");
        ...
        configuration.setWindowIcon("echoeslua128.png", "echoeslua64.png",
            "echoeslua32.png", "echoeslua16.png");
